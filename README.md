# [Русский readme](https://github.com/efefew/efefew/blob/main/README_RUS.md)
...
C# Developer (starting from 2017) with 9 years of programming experience in Unity. Skilled in game development, including gameplay mechanics, animation control, UI creation, and sound effect integration. Experienced working across multiple platforms and operating systems, including iOS, Android, and Windows.
...
* Developed Unity games for publication on Yandex Games (WebGL).
  Link: [example](https://yandex.ru/games/app/391490?utm_source=game_header_logo)
